...
use crate::prelude::Clip;
use crate::{
    geom::{Mesh, Tri, Vertex3},
    math::{Lerp, mat::Mat4x4, vary::Vary},
};

use super::{Context, NdcToScreen, Render, Shader, Target};
...
impl<Prim, Vtx: Clone, Uni: Copy, Shd, Tgt: Target, Ctx: Borrow<Context>>
    Batch<Prim, Vtx, Uni, Shd, &mut Tgt, Ctx>
{
